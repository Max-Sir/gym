...
/**
 * Util class to check training program data during creation and edition.
 *
 * @author Eugene Makarenko
 * @see by.epam.gym.entities.TrainingProgram
 */
public class TrainingProgramDataValidator {
    ...
    /**
     * This method checks exercises count per day.
     *
    ...
    /**
     * This method checks training program data.
     *
