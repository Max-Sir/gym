    ...
    <ul>
        <li>
            <form action="${pageContext.request.contextPath}/jsp/client/prepare_order.jsp">
                <button type="submit">${pageScope.edit_button} <i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
            </form>
        </li>
        <li>
            <form method="POST" action="${pageContext.request.contextPath}/controller">
                <input type="hidden" name="command" value="client_pay_order" />
                <button type="submit">${pageScope.pay_button} <i class="fa fa-credit-card" aria-hidden="true"></i></button>
            </form>
        </li>
    </ul>
</div>
